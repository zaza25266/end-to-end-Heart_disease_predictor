...
**3. Training & Tuning**
Trained Logistic Regression, Random Forest, LightGBM, and XGBoost. Used GridSearchCV with Cross-Validation , regularization to find the best settings for each. Picked Logistic Regression in the end — it matched Random Forest on recall but runs faster.
...
├── requirements.txt
└── setup.py
```# simple-end-to-end-Heart_disease_predictor
